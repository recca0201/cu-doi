...
const kArenas = [
  ...
  },
  {
    ...
    targets: [target(20, 36, 3, 1), target(50, 28, 3, 2), target(80, 36, 4, 3)],
    blocks: [],
    deflectors: [],
    starThresholds: [750, 1100, 1350],
  },
  ...
  },
  {
    ...
    targets: [target(26, 52, 3, 0), target(74, 52, 3, 1), target(50, 22, 2, 2)],
    blocks: [block(44, 66, 56, 118)],
    deflectors: [],
    starThresholds: [650, 950, 1150],
  },
  {
    id: 6, name: "Ngóc ngách", shots: 3,
