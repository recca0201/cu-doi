...
/// 721 aim angles per board state. Do not edit this file by hand.
const List<ArenaSpec> kArenas = <ArenaSpec>[
  ...
  ArenaSpec(
    ...
    targets: <TargetSpec>[
      ...
      TargetSpec(V2(50, 28), 3, palette: 2),
      TargetSpec(V2(80, 36), 4, palette: 3),
    ],
    starThresholds: <int>[750, 1100, 1350],
  ),
  ArenaSpec(
  ...
  ArenaSpec(
    ...
    shots: 3,
    targets: <TargetSpec>[
      TargetSpec(V2(26, 52), 3, palette: 0),
      TargetSpec(V2(74, 52), 3, palette: 1),
      TargetSpec(V2(50, 22), 2, palette: 2),
    ],
    blocks: <BlockSpec>[
  ...
  ArenaSpec(
    ...
    starThresholds: <int>[1000, 1450, 1800],
  ),
  ArenaSpec(
    id: 19,
    name: 'Hai lưỡi dao',
