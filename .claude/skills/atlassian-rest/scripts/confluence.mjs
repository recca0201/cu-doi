...
function checkEnv() {
  ...
  if (missing.length > 0) {
    ...
    console.error('  1. Create a .env file at the project root or skill directory:');
    console.error('       ATLASSIAN_EMAIL=you@example.com');
    console.error('       ATLASSIAN_DOMAIN=mycompany.atlassian.net');
    console.error('       ATLASSIAN_API_TOKEN=your-api-token');
    console.error('  2. Export in your shell:');
