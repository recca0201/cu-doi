...
function printSetupGuide(missing) {
  ...
  console.log('3. RECOMMENDED — create a .env file at the project root (never commit it):\n');
  console.log('   ATLASSIAN_EMAIL=you@example.com');
  console.log('   ATLASSIAN_DOMAIN=mycompany.atlassian.net');
  console.log('   ATLASSIAN_API_TOKEN=your-api-token\n');
  console.log('   Scripts load it automatically. Copy .env.example as a starting point:\n');
  console.log('   cp <skill-path>/.env.example .env\n');

  console.log('   ALTERNATIVE — export in your shell or add to ~/.zshrc / ~/.bashrc:\n');
