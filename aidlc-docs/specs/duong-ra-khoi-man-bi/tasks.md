...
- [x] 9.4 Run test to verify it passes
  ...
  - Command: `flutter test test/sim/hint_finder_test.dart`
  - Expected: PASS.
- [x] 9.5 Add the deadline and the sim-boundary guard
...
- [x] 12.5 Kiểm token và khả năng phân biệt
...
- [x] 13.4 Run test to verify it passes
  ...
  - Command: `flutter test test/ui/game_screen_hint_test.dart`
  - Expected: PASS.
- [x] 13.5 Nối phản hồi "đang tính" và announcement
  - Reference: US-1 AC-2.4
...
- [x] 14.4 Run test to verify it passes
  ...
  - Command: `flutter test test/state/progress_controller_test.dart`
  - Expected: PASS.
- [x] 14.5 Chốt một bộ đếm duy nhất
...
- [x] 15.4 Run test to verify it passes
  ...
  - Command: `flutter test test/ui/game_screen_skip_test.dart`
  - Expected: PASS.
- [x] 15.5 Nối kết quả và điều hướng
...
- [x] 19.1 Nối `hintControllerProvider` vào cây provider
...
- [x] 19.2 Chạy toàn bộ test và phân tích tĩnh
...
- [x] 19.3 Kiểm vòng lưu–đọc đầu-cuối
