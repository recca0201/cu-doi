...
| Q2 | `samples = 361` cho phép quét góc có đủ nhanh trong isolate trên máy tầm thấp? | Không | Đủ. `tools/solver/` đã quét đúng 361 góc mỗi trạng thái sân và đó là ngân sách đã dùng để tune cả 20 màn. Nếu đo thấy chậm, hạ `samples` là tham số, không phải đổi thiết kế. |
