...
- [ ] 1.1 Viết test RED cho mô hình hồ sơ và phép tính tổng quan
...
- [ ] 1.2 Chạy test mục tiêu để xác nhận RED đúng nguyên nhân
...
- [ ] 1.3 Cài đặt tối thiểu model hồ sơ và summary tất định
  - Reference: US-1 AC-2.1, US-1 AC-2.2, US-1 AC-2.3, US-2 AC-1.1, US-2 AC-2.1, US-2 AC-2.2, US-2 AC-2.3, US-4 AC-1.1, US-4 AC-1.2, US-4 AC-1.3, US-4 AC-3.1, US-4 AC-3.2, US-4 AC-3.3, US-4 AC-3.4, US-4 AC-3.5
...
- [ ] 1.4 Chạy lại test domain để xác nhận GREEN
...
- [ ] 2.1 Viết test RED cho truth table gộp và schema dense 20 màn
...
- [ ] 2.2 Chạy test merge để xác nhận RED
...
- [ ] 2.3 Cài đặt merge và codec cloud tối thiểu
  - Reference: US-4 AC-2.1, US-4 AC-2.2, US-4 AC-2.3, US-4 AC-2.4, US-4 AC-2.5, US-4 AC-4.1, US-4 AC-4.2, US-4 AC-4.3, US-6 AC-1.1, US-6 AC-1.3, US-6 AC-2.1, US-6 AC-2.2, US-6 AC-2.3, US-6 AC-2.7
...
- [ ] 2.4 Xác nhận GREEN và boundary gameplay bất biến
...
- [ ] 3.1 Viết test RED cho envelope, provenance, migration và process death
...
- [ ] 3.2 Chạy test local store để xác nhận RED
...
- [ ] 3.3 Cài đặt LocalPlayerStore, OwnerKey/OwnerLease và migration
  - Reference: US-2 AC-3.1, US-2 AC-3.2, US-3 AC-3.1, US-3 AC-3.4, US-3 AC-3.5, US-6 AC-3.1, US-6 AC-3.2, US-6 AC-3.3, US-6 AC-3.4, US-6 AC-3.5, US-6 AC-4.5
...
- [ ] 3.4 Chạy lại local persistence tests để xác nhận GREEN
...
- [ ] 4.1 Viết test RED cho hàng đợi save và đổi owner giữa callback
...
- [ ] 4.2 Chạy controller test để xác nhận RED
...
- [ ] 4.3 Refactor ProgressRepository/ProgressController theo owner lease
  - Reference: US-5 AC-1.1, US-5 AC-1.2, US-6 AC-4.1, US-6 AC-4.2, US-6 AC-4.4, US-6 AC-4.5, US-7 AC-2.3, US-7 AC-2.4, US-7 AC-3.4
...
- [ ] 4.4 Xác nhận GREEN cho gameplay/state hiện có
...
- [ ] 5.1 Viết test RED cho ProfileController và lỗi lưu tên
...
- [ ] 5.2 Chạy profile controller test để xác nhận RED
...
- [ ] 5.3 Cài đặt ProfileController và local mutation queue tối thiểu
  - Reference: US-2 AC-1.2, US-2 AC-1.3, US-2 AC-2.4, US-2 AC-2.5, US-2 AC-3.3, US-2 AC-3.4, US-2 AC-3.5, US-6 AC-2.4, US-6 AC-2.5, US-6 AC-2.6
...
- [ ] 5.4 Chạy lại profile/name tests để xác nhận GREEN
...
- [ ] 6.1 Viết test RED cho xử lý, thay thế và dọn file avatar
...
- [ ] 6.2 Chạy avatar data tests để xác nhận RED
...
- [ ] 6.3 Cài đặt avatar processing/cache tối thiểu
  - Reference: US-3 AC-2.3, US-3 AC-2.5, US-3 AC-2.6, US-3 AC-2.7, US-3 AC-3.2, US-3 AC-3.3, US-3 AC-3.4
...
- [ ] 6.4 Xác nhận GREEN cho pipeline và failure recovery
...
- [ ] 7.1 Viết test/validator RED cho bootstrap và đầu vào phát hành
...
- [ ] 7.2 Chạy bootstrap/config tests để xác nhận RED
...
- [ ] 7.3 Thêm dependencies và cấu hình Firebase/emulator tối thiểu
...
- [ ] 7.4 Xác nhận GREEN cho guest bootstrap và release validator
  - Reference: US-5 AC-1.1, US-5 AC-2.3, US-6 AC-5.3, US-6 AC-5.4, US-6 AC-5.5
  - Command: `flutter test test/firebase/bootstrap_test.dart && node --test test/firebase/verify_config.test.mjs`
...
- [ ] 8.1 Viết rules tests RED cho allowlist và deny-by-default
...
- [ ] 8.2 Chạy Emulator rules tests để xác nhận RED
...
- [ ] 8.3 Cài đặt Firestore/Storage Rules và test harness
  - Reference: US-6 AC-1.1, US-6 AC-1.2, US-6 AC-5.1, US-6 AC-5.2, US-6 AC-5.3, US-6 AC-5.4, US-6 AC-5.5
...
- [ ] 8.4 Xác nhận GREEN cho rules suite
...
- [ ] 9.1 Viết test RED cho sign-in/link/cancel/conflict/offline restore
...
- [ ] 9.2 Chạy account tests để xác nhận RED
...
- [ ] 9.3 Cài đặt FirebaseAccountRepository và AccountController tối thiểu
  - Reference: US-5 AC-2.1, US-5 AC-2.2, US-5 AC-2.3, US-5 AC-2.4, US-5 AC-3.1, US-5 AC-3.2, US-5 AC-3.3, US-7 AC-1.1, US-7 AC-1.2, US-7 AC-1.3, US-7 AC-1.4, US-7 AC-1.5
...
- [ ] 9.4 Xác nhận GREEN cho identity transitions
...
- [ ] 10.1 Viết test RED cho reconcile, retry và total-order profile mutation
...
- [ ] 10.2 Chạy client/backend sync tests để xác nhận RED
...
- [ ] 10.3 Cài đặt SyncController, Firestore transaction và commitProfileMutation
  - Reference: US-2 AC-3.4, US-2 AC-3.5, US-6 AC-2.4, US-6 AC-2.5, US-6 AC-2.6, US-6 AC-3.3, US-6 AC-3.5, US-6 AC-4.1, US-6 AC-4.2, US-6 AC-4.3, US-6 AC-4.4, US-6 AC-4.5
...
- [ ] 10.4 Xác nhận GREEN cho sync và restart cases
...
- [ ] 11.1 Viết test RED cho upload/reference/delete/download/cleanup
...
- [ ] 11.2 Chạy avatar cloud tests để xác nhận RED
  - Reference: US-3 AC-3.6, US-3 AC-3.7, US-3 AC-3.8, US-3 AC-3.9, US-6 AC-1.2, US-6 AC-5.2
...
- [ ] 11.3 Cài đặt avatar callables, validated cache và scheduled cleanup
  - Reference: US-3 AC-3.6, US-3 AC-3.7, US-3 AC-3.8, US-3 AC-3.9, US-6 AC-1.2, US-6 AC-5.2
...
- [ ] 11.4 Xác nhận GREEN cho avatar cloud lifecycle
  - Reference: US-3 AC-3.6, US-3 AC-3.7, US-3 AC-3.8, US-3 AC-3.9, US-6 AC-1.2, US-6 AC-5.2
  - Command: `flutter test test/data/avatar_cache_repository_test.dart && npm --prefix functions test -- avatar_service.test.ts avatar_cleanup.test.ts`
...
- [ ] 12.1 Viết test RED cho deletion job, receipt và provider recovery
...
- [ ] 12.4 Xác nhận GREEN cho deletion failure matrix
...
- [ ] 13.1 Viết test RED cho local deletion precommit/freeze/poll/recovery
...
- [ ] 13.2 Chạy deletion controller tests để xác nhận RED
...
- [ ] 13.3 Cài đặt AccountDeletionRepository và client transitions
  - Reference: US-7 AC-3.1, US-7 AC-3.2, US-7 AC-3.3, US-7 AC-3.4, US-7 AC-3.6, US-7 AC-3.7, US-7 AC-3.8
...
- [ ] 13.4 Xác nhận GREEN cho deletion client lifecycle
  - Reference: US-7 AC-3.3, US-7 AC-3.4, US-7 AC-3.6, US-7 AC-3.7, US-7 AC-3.8
...
- [ ] 14.1 Viết widget test RED cho avatar/panel semantics và navigation
...
- [ ] 14.2 Chạy menu/avatar widget tests để xác nhận RED
...
- [ ] 14.3 Cài đặt PlayerAvatar và menu profile route
  - Reference: US-1 AC-1.1, US-1 AC-1.2, US-1 AC-1.3, US-2 AC-3.3, US-3 AC-4.2
...
- [ ] 14.4 Xác nhận GREEN cho menu navigation regression
  - Reference: US-1 AC-1.1, US-1 AC-1.2, US-1 AC-1.3, US-2 AC-3.3, US-3 AC-4.2
...
- [ ] 15.1 Viết widget/golden tests RED cho layout và trạng thái tổng quan
...
- [ ] 15.2 Chạy profile tests để xác nhận RED
...
- [ ] 15.3 Dựng ProfileScreen overview và VI/EN strings
  - Reference: US-1 AC-2.1, US-1 AC-2.2, US-1 AC-2.3, US-1 AC-2.4, US-1 AC-2.5, US-1 AC-3.1, US-1 AC-3.2, US-1 AC-3.3, US-1 AC-3.4, US-1 AC-3.5
...
- [ ] 15.4 Xác nhận GREEN cho overview, golden và ARB parity
...
- [ ] 16.1 Viết widget tests RED cho 4 accordion, 20 record và 8 badge
...
- [ ] 16.2 Chạy profile detail tests để xác nhận RED
...
- [ ] 16.3 Cài đặt progress/badge/record sections
  - Reference: US-4 AC-1.1, US-4 AC-1.2, US-4 AC-1.3, US-4 AC-2.1, US-4 AC-2.2, US-4 AC-2.3, US-4 AC-2.4, US-4 AC-2.5, US-4 AC-3.1, US-4 AC-3.2, US-4 AC-3.3, US-4 AC-3.4, US-4 AC-3.5
...
- [ ] 16.4 Xác nhận GREEN cho detail UI và domain consistency
...
- [ ] 17.1 Viết widget tests RED cho preset, picker, crop và error states
...
- [ ] 17.2 Chạy avatar editor tests để xác nhận RED
...
- [ ] 17.3 Cài đặt AvatarEditorScreen và nối ProfileController
  - Reference: US-3 AC-1.1, US-3 AC-1.2, US-3 AC-1.3, US-3 AC-2.1, US-3 AC-2.2, US-3 AC-2.4, US-3 AC-2.5, US-3 AC-2.6, US-3 AC-4.1, US-3 AC-4.2
...
- [ ] 17.4 Xác nhận GREEN cho avatar UI và data recovery
...
- [ ] 18.1 Viết widget tests RED cho account card và destructive flows
...
- [ ] 18.2 Chạy account UI tests để xác nhận RED
...
- [ ] 18.3 Cài đặt account card, branded actions và lifecycle dialogs
  - Reference: US-5 AC-2.1, US-5 AC-2.2, US-5 AC-3.1, US-5 AC-3.2, US-7 AC-1.1, US-7 AC-1.2, US-7 AC-1.4, US-7 AC-1.5, US-7 AC-2.1, US-7 AC-2.2, US-7 AC-2.3, US-7 AC-2.4, US-7 AC-3.1, US-7 AC-3.2, US-7 AC-3.6, US-7 AC-3.7, US-7 AC-3.8
...
- [ ] 18.4 Xác nhận GREEN cho account UI states
...
- [ ] 19.1 Viết widget tests RED cho reminder và reset guard
...
- [ ] 19.2 Chạy reminder/settings tests để xác nhận RED
...
- [ ] 19.3 Cài đặt result-sheet reminder, logout copy và Settings guard
  - Reference: US-5 AC-1.3, US-7 AC-2.1, US-7 AC-2.2, US-7 AC-2.3, US-7 AC-2.4
...
- [ ] 19.4 Xác nhận GREEN và gameplay timing regression
...
- [ ] 20.1 Viết/hoàn thiện config tests RED cho Android/iOS provider wiring
...
- [ ] 20.2 Chạy platform verifier để xác nhận RED
...
- [ ] 20.3 Thêm platform config có thể kiểm thử, không điền production identity giả
  - Reference: US-3 AC-2.1, US-3 AC-4.1, US-5 AC-2.2, US-5 AC-2.3, US-6 AC-5.4
...
- [ ] 20.4 Xác nhận GREEN cho config fixtures và emulator build path
...
- [ ] 21.1 Viết integration tests RED cho luồng đa thiết bị và failure injection
...
- [ ] 21.2 Chạy integration suite để xác nhận RED
...
- [ ] 21.3 Hoàn thiện wiring providers, emulator fixtures và restart hooks
  - Reference: US-3 AC-3.6, US-3 AC-3.7, US-3 AC-3.8, US-3 AC-3.9, US-5 AC-2.4, US-6 AC-4.2, US-6 AC-4.3, US-6 AC-4.4, US-6 AC-4.5, US-7 AC-1.3, US-7 AC-3.4, US-7 AC-3.5, US-7 AC-3.7
...
- [ ] 21.4 Xác nhận GREEN cho integration và performance budgets
...
- [ ] 22.1 Thêm boundary/regression assertions còn thiếu trước khi final wiring
...
- [ ] 22.2 Chạy targeted regression để bắt RED còn lại
...
- [ ] 22.3 Sinh localization, sửa wiring tối thiểu và khóa phạm vi
  - Reference: US-1 AC-3.5, US-3 AC-2.3, US-4 AC-4.2, US-4 AC-4.3, US-6 AC-5.1, US-6 AC-5.2, US-6 AC-5.3, US-6 AC-5.4, US-6 AC-5.5
...
- [ ] 22.4 Chạy toàn bộ static analysis, Flutter, Functions và rules tests
  - Reference: US-1 AC-3.5, US-3 AC-2.3, US-4 AC-4.2, US-4 AC-4.3, US-6 AC-5.1, US-6 AC-5.2, US-6 AC-5.3, US-6 AC-5.4, US-6 AC-5.5
